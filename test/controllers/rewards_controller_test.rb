...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { amount: @reward.amount, recipient: @reward.recipient, reward_type_id: @reward.reward_type_id } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { amount: @reward.amount, recipient: @reward.recipient, reward_type_id: @reward.reward_type_id } }
